                ...
                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      <Avatar imgUrl={currentUser?.avatar} sizeClass="w-12 h-12" />

                      <div className="flex-grow">
                        <h4 className="font-semibold">{currentUser?.username}</h4>
                        <p className="text-xs mt-0.5">Astoria, NY</p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p onClick={handleSignOut} className="text-sm font-medium ">{"Log out"}</p>
                      </div>
                    </Link>
                  </div>
                </div>
